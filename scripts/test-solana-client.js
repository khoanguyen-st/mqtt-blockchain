...
async function testSolanaClient() {
  ...
  try {
    ...
    if (recordResult.success) {
      ...
      console.log(
        "   Explorer:",
        solanaClient.getExplorerUrl(recordResult.signature)
      );
      console.log("");
      ...
      const verifyResult = await solanaClient.verifyBatch(
        recordResult.signature
      );
      ...
      if (verifyResult.verified) {
        ...
        console.log(
          "   Block Time:",
          new Date(verifyResult.blockTime * 1000).toISOString()
        );
